                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <span className={`text-xs font-bold ${deposit.status === "PENDING" ? "text-amber-500" :
                                                deposit.status === "APPROVED" ? "text-emerald-500" : "text-rose-500"
                                            }`}>
                                            {deposit.status}
                                        </span>
                                    </div>
                                ...
                                <div className="text-center md:text-right">
                                    <p className="text-2xl font-bold text-emerald-500">${deposit.amount?.toLocaleString()}</p>
